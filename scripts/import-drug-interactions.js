...
const drugInteractionDatabase = {
  ...
  lisinopril: {
    ...
    nsaids: { severity: 'moderate', description: 'May reduce antih hypertensive effect and increase risk of renal impairment.', mechanism: 'NSAIDs inhibit renal prostaglandin synthesis', recommendation: 'Monitor blood pressure and renal function' },
...
async function importInteractions() {
  ...
  for (const [drug1, interactions] of Object.entries(drugInteractionDatabase)) {
    try {
      ...
      console.error(`Error processing ${drug1}:`, err.message)
    }
  }
