...
const drugInteractionDatabase: Record<string, Record<string, {
  severity: string
  description: string
  mechanism: string
...
export async function GET() {
  return NextResponse.json({
    message: 'POST to this endpoint to import drug interactions',
    usage: '/api/admin/import-interactions?secret=YOUR_SECRET'
  })
}